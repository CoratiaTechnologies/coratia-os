...
BLUEOS_BOOTSTRAP="coratia/blueos-bootstrap:$VERSION" # Use current version
BLUEOS_CORE="coratia/blueos-core:$VERSION" # We don't have a stable tag yet
BLUEOS_FACTORY="coratia/blueos-core:factory" # used for "factory reset"
